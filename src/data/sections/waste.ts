...
export const wasteMeta: SectionMeta = {
  ...
  description: 'Most of what we buy is designed to be thrown away. How you sort, reduce, and redirect that waste determines how much of it actually avoids the landfill.',
  maxRaw: 35,
  scaledMax: 35,
}
...
export const wasteQuestions: Question[] = [
  {
    ...
    whyItMatters:
      "Plastic bottles are among the most littered items on the planet. Globally, over 500 billion plastic bottles are sold every year. A reusable bottle eliminates hundreds of single-use items per person annually.",
    options: [
  ...
  },
  {
    ...
    whyItMatters:
      "Source segregation is the single most important factor in whether waste is recycled or composted. When everything goes into one bin, recyclables and compostables are contaminated — and landfilled. Only a fraction of plastic waste globally is ever recycled.",
    options: [
  ...
  },
  {
    ...
    whyItMatters:
      "A cloth bag's lifetime environmental impact is decisively lower than single-use plastic once a break-even reuse threshold (~130 uses) is crossed. Single-use bags are among the most common items recovered from coastlines and waterways worldwide.",
    options: [
