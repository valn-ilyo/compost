// Section meta and question definitions for the water section
...
export const waterQuestions: Question[] = [
  {
    ...
    whyItMatters:
      "Bathing is the single largest discretionary domestic water use. The numbers: a bucket bath uses 15–20 litres, a 10-minute shower 60–80 litres, a full bathtub 150–300 litres. This one choice accounts for the largest share of your daily water footprint.",
    options: [
  ...
  },
  {
    ...
    whyItMatters:
      "A standard tap flows at around 6 litres per minute. Leaving it running for 2 minutes while brushing teeth wastes around 12 litres, nearly a full bucket bath. Across a household of four brushing twice daily, that's over 17,000 litres wasted per year from tooth brushing alone.",
    options: [
  ...
  },
  {
    ...
    whyItMatters:
      "A running tap during a 5-minute dishwash uses around 30 litres. Washing in a filled basin uses 5–10 litres for the same load, a saving of 65–80%. Unlike brief tap-off moments during brushing, dishwashing involves sustained water use over several minutes, making the volume at stake significantly larger.",
    options: [
  ...
  },
  {
    ...
    whyItMatters:
      "A washing machine uses 50–70 litres per cycle regardless of load size, so a half load doubles the per-garment water cost. Hand washing under a running tap for 10 minutes uses around 60 litres for just a few items. Bucket hand washing in batches is the most water-efficient method overall.",
    options: [
      {
  ...
  },
  {
    ...
    whyItMatters:
      "Producing one litre of commercially bottled water requires around 3 litres of water in manufacturing and significantly more energy than treating tap water. At 2 litres per day, single-use bottles add up to around 730 bottles per year. Where tap water is safe and tested, it's the most environmentally sound option.",
    options: [
  ...
  {
    id: "leak_reporting",
    text: "If you notice a dripping tap or leaking pipe in your home or shared building, what do you do?",
    whyItMatters:
