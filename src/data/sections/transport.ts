// Section meta and question definitions for the transport section
...
export const transportMeta: SectionMeta = {
  ...
  description:
    "How you get around is typically the largest or second-largest component of your personal carbon footprint. Your daily travel choices carry serious weight.",
  maxRaw: 25,
  scaledMax: 75,
};
