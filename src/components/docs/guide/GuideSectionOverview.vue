    ...
    <v-card flat rounded="xl" class="mb-8">
      <v-card-text>
        <p class="text-body-2 mb-3">
          ...
          and where small changes would matter most.
        </p>
        <p class="text-body-2 mb-3">
          Your score updates as you complete sections. Add habits from the library and log them each
          day to track consistency over time.
        </p>
        <p class="text-body-2">
