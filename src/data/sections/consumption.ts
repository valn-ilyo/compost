// Section meta and question definitions for the consumption section
...
export const consumptionMeta: SectionMeta = {
  ...
  description:
    'The things you buy carry an environmental cost long before they reach you. From printing habits and clothing to device longevity and circular choices, it all adds up.',
  maxRaw: 20,
  scaledMax: 40,
}
