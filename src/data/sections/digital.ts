// Section meta and question definitions for the digital section
...
export const digitalMeta: SectionMeta = {
  ...
  description:
    "The internet produces roughly as much CO₂ as global aviation, and that footprint is still growing. Your streaming, browsing, and device habits all add up.",
  maxRaw: 25,
  scaledMax: 25,
};
...
export const digitalQuestions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "I have multiple cloud accounts and back up everything automatically without review",
        points: 1,
      },
    ],
  },
  ...
  },
  {
    ...
    options: [
      {
        label: "Intentional. I use devices for specific purposes and close apps when done",
        points: 5,
      },
