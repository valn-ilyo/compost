...
<template>
  ...
  <VCard flat rounded="xl" class="mb-8">
    <VListItem title="Raw score" class="pt-4" />
    ...
    <VListItem title="Scaled score" class="pt-2" />
    <VCardText class="pt-1 pb-3">
    ...
    <VListItem title="Normalised score" class="pt-2" />
  ...
  <VCard flat rounded="xl" class="mb-8">
    ...
    <VListItem title="Transport and food (23.1% each)" class="pt-2" />
    <VCardText class="pt-1 pb-3">
      <p class="text-body-2">
    ...
    <VListItem title="Energy (15.4%)" class="pt-2" />
    <VCardText class="pt-1 pb-3">
      <p class="text-body-2">
    ...
    <VListItem title="Consumption (12.3%)" class="pt-2" />
    <VCardText class="pt-1 pb-3">
      <p class="text-body-2">
    ...
    <VListItem title="Waste (10.8%)" class="pt-2" />
    <VCardText class="pt-1 pb-3">
      <p class="text-body-2">
    ...
    <VListItem title="Water and digital (7.7% each)" class="pt-2" />
    <VCardText class="pt-1 pb-4">
      <p class="text-body-2">
