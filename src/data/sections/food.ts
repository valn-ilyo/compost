// Section meta and question definitions for the food section
...
export const foodMeta: SectionMeta = {
  ...
  description:
    "What you eat and how much you waste are two of the highest-impact daily choices you make. Diet and food habits shape a significant slice of your footprint.",
  maxRaw: 25,
  scaledMax: 75,
};
...
export const foodQuestions: Question[] = [
  {
    id: "diet_type",
    text: "What best describes your usual diet? Your most typical pattern, not your best or worst day.",
    whyItMatters:
      "Animal-sourced foods contribute 56–58% of food-related greenhouse gas emissions despite providing only 37% of global protein. Beef produces approximately 35 kg CO₂eq per 100g protein, roughly 90 times the footprint of peas. A full dietary shift away from animal products could reduce food-system emissions by approximately 49% globally.",
    options: [
  ...
  },
  {
    ...
    whyItMatters:
      "Roughly one-third of all food produced globally is lost or wasted, around 1.3 billion tonnes per year. The carbon footprint of that waste is approximately 3.3 billion tonnes of CO₂eq annually, which would make it the world's third-largest emitter if counted as a country. Every meal wasted carries the full embedded emissions of its production.",
    options: [
  ...
  },
  {
    ...
    whyItMatters:
      "Saving leftovers prevents all the emissions, water, and land that went into producing that food from going to waste. In many South and Southeast Asian countries, the cultural practice of saving leftovers already represents a built-in sustainability advantage. This question rewards and reinforces it.",
    options: [
  ...
  },
  {
    ...
    whyItMatters:
      "Packaged food carries two environmental costs: the production footprint and the packaging waste footprint. Food processing and packaging account for around 6% of total food-system emissions, which compounds with the agricultural footprint of the contents, plus unrecyclable packaging entering the waste stream.",
    options: [
  ...
  },
  {
    ...
    whyItMatters:
      "Locally and seasonally sourced food has a substantially lower transport and storage emissions footprint than imported or out-of-season equivalents. Transport accounts for approximately 6% of food-system emissions, a share that compounds with the processing and packaging footprint of imported foods. Fresh, local, unpackaged produce also generates less plastic waste.",
    options: [
