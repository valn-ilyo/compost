...
export const transportQuestions: Question[] = [
  {
    ...
    options: [
      ...
      { label: 'Private car — alone or single-occupancy drop', points: 1 },
    ],
  },
  {
    id: 'commute_distance',
    ...
    whyItMatters:
      'Distance shapes the total carbon budget of every trip you make. Those who live on-site or within walking distance have structurally near-zero commute emissions. Longer distances make active travel difficult and increase dependence on motorised transport.',
    options: [
  ...
  },
  {
    ...
    whyItMatters:
      'Frequency multiplies the emissions of any given mode choice. Daily motorised commuting compounds the impact of using a private vehicle. Those who work remotely, live on-site, or travel infrequently have structurally lower transport footprints regardless of mode.',
    options: [
  ...
  {
    id: 'short_trips',
    text: 'For short local trips under 2 km — errands, quick visits, nearby shops — what do you usually do?',
    whyItMatters:
      'Short motorised trips from a cold engine can produce up to twice the per-kilometre CO₂ of a longer journey. Walking eliminates emissions entirely and is time-competitive with a vehicle in most urban and peri-urban settings for distances under 2 km. These are among the most avoidable transport emissions in daily life.',
    options: [
  ...
  },
  {
    ...
    whyItMatters:
      'Mode preference for discretionary travel — not just the daily commute — is a strong predictor of total personal transport emissions. Consistent shared-mode use across all trip types, not just peak-hour commuting, keeps the full transport footprint low.',
    options: [
      ...
      { label: 'Never — always private vehicle', points: 1 },
    ],
  },
]
